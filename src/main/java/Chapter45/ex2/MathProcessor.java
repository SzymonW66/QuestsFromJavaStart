...
public class MathProcessor implements StringTemplate.Processor<BigInteger, IllegalArgumentException>{
    ...
    public BigInteger process(StringTemplate template) {
        ...
        if(!matcher.matches()) {
            throw new IllegalArgumentException(STR."Procesor nie jest w stanie obsłużyć działania \{interpolatedTemplate}");
        }
